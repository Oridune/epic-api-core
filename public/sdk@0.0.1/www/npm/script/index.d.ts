...
export declare class EpicSDK {
    protected static _cachingActivity: Map<string, {
    ...
    static expireCache(keys: TCacheKey): Promise<boolean>;
    static delCache(keys: TCacheKey): Promise<boolean>;
    static cacheKeys(startsWith?: string): Promise<string[]>;
    ...
    static withCaching(callback: (methods: ReturnType<typeof EpicSDK.useCaching>, key: string) => void | Promise<void>, options?: {
        matcher?: RegExp;
    }): Promise<void>;
    ...
    static walletAddresses: import("./modules/walletAddresses.js").IController$walletAddresses;
    static walletMonitoring: import("./modules/walletMonitoring.js").IController$walletMonitoring;
    static extensions: {
