...
export interface IController$users {
    ...
    updateAvatarDELETE<Method extends "delete", QueryShape extends TRoute$users$updateAvatarDELETE["query"], ParamsShape extends TRoute$users$updateAvatarDELETE["params"], BodyShape extends TRoute$users$updateAvatarDELETE["body"], ReturnShape extends TResponseShape<any> = TRoute$users$updateAvatarDELETE["return"]>(data: {
        method?: Method;
        query?: QueryShape;
        params?: ParamsShape;
        body?: BodyShape;
    } & TRequestOptions<ReturnShape>): TRequestExecutors<ReturnShape, BodyShape>;
    updateAvatarPUT<Method extends "put", QueryShape extends TRoute$users$updateAvatarPUT["query"], ParamsShape extends TRoute$users$updateAvatarPUT["params"], BodyShape extends TRoute$users$updateAvatarPUT["body"], ReturnShape extends TResponseShape<any> = TRoute$users$updateAvatarPUT["return"]>(data: {
        method?: Method;
        query?: QueryShape;
        params?: ParamsShape;
        body: BodyShape;
