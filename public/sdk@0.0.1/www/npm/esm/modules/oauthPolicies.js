export const oauthPoliciesModule = (sdk) => {
    const methods = {
        me(data) {
    ...
    methods.me.__permission = "oauthPolicies.me";
    methods.create.__permission = "oauthPolicies.create";
    methods.update.__permission = "oauthPolicies.update";
    methods.delete.__permission = "oauthPolicies.delete";
    methods.get.__permission = "oauthPolicies.get";
    return methods;
};
