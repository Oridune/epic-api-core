export const usersModule = (sdk) => {
    const methods = {
        ...
        updateAvatarDELETE(data) {
            return sdk.resolveAxiosResponse(async () => {
                if (!sdk._axios)
                    throw new Error("Axios not initialized!");
                sdk.checkPermission("users", "updateAvatarDELETE");
                const url = Object.entries(data?.params ?? {}).reduce((endpoint, [key, value]) => endpoint.replace(new RegExp(`:${key}\\??`, "g"), value ?? ""), "/api/users/avatar").replace(/:\w+\?\/?/g, "");
                const res = await sdk._axios.request({
    ...
    methods.updateAvatar.__permission = "users.updateAvatar";
    methods.updateAvatarDELETE.__permission = "users.updateAvatarDELETE";
    methods.updateAvatarPUT.__permission = "users.updateAvatarPUT";
    methods.setFcmToken.__permission = "users.setFcmToken";
    methods.deleteFcmToken.__permission = "users.deleteFcmToken";
    methods.updateEmail.__permission = "users.updateEmail";
    methods.update.__permission = "users.update";
    methods.me.__permission = "users.me";
    methods.updatePassword.__permission = "users.updatePassword";
    methods.updatePhone.__permission = "users.updatePhone";
    methods.verify.__permission = "users.verify";
    methods.delete.__permission = "users.delete";
    methods.updateRole.__permission = "users.updateRole";
    methods.get.__permission = "users.get";
    methods.create.__permission = "users.create";
    methods.toggleBlocked.__permission = "users.toggleBlocked";
    return methods;
};
