export const envsModule = (sdk) => {
    ...
    methods.create.__permission = "envs.create";
    methods.update.__permission = "envs.update";
    methods.delete.__permission = "envs.delete";
    methods.get.__permission = "envs.get";
    return methods;
};
