...
export interface IController$requestLogIgnores {
    create<Method extends "post", QueryShape extends TRoute$requestLogIgnores$create["query"], ParamsShape extends TRoute$requestLogIgnores$create["params"], BodyShape extends TRoute$requestLogIgnores$create["body"], ReturnShape extends TResponseShape<any> = TRoute$requestLogIgnores$create["return"]>(data: {
        method?: Method;
        query?: QueryShape;
        params?: ParamsShape;
        body: BodyShape;
...
export declare const requestLogIgnoresModule: (sdk: any) => IController$requestLogIgnores;
//# sourceMappingURL=requestLogIgnores.d.ts.map