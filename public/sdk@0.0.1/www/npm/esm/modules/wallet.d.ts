...
export interface IController$wallet {
    ...
    attach<Method extends "get", QueryShape extends TRoute$wallet$attach["query"], ParamsShape extends TRoute$wallet$attach["params"], BodyShape extends TRoute$wallet$attach["body"], ReturnShape extends TResponseShape<any> = TRoute$wallet$attach["return"]>(data: {
        method?: Method;
        query: QueryShape;
        params?: ParamsShape;
        body?: BodyShape;
    } & TRequestOptions<ReturnShape>): TRequestExecutors<ReturnShape, BodyShape>;
    attachDELETE<Method extends "delete", QueryShape extends TRoute$wallet$attachDELETE["query"], ParamsShape extends TRoute$wallet$attachDELETE["params"], BodyShape extends TRoute$wallet$attachDELETE["body"], ReturnShape extends TResponseShape<any> = TRoute$wallet$attachDELETE["return"]>(data: {
        method?: Method;
        query?: QueryShape;
        params?: ParamsShape;
        body?: BodyShape;
    } & TRequestOptions<ReturnShape>): TRequestExecutors<ReturnShape, BodyShape>;
    attachPUT<Method extends "put", QueryShape extends TRoute$wallet$attachPUT["query"], ParamsShape extends TRoute$wallet$attachPUT["params"], BodyShape extends TRoute$wallet$attachPUT["body"], ReturnShape extends TResponseShape<any> = TRoute$wallet$attachPUT["return"]>(data: {
        method?: Method;
        query?: QueryShape;
        params?: ParamsShape;
        body: BodyShape;
