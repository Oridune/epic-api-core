export const accountInvitesModule = (sdk) => {
    const methods = {
        create(data) {
    ...
    methods.create.__permission = "accountInvites.create";
    methods.delete.__permission = "accountInvites.delete";
    methods.get.__permission = "accountInvites.get";
    return methods;
};
