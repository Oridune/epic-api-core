...
const manageWalletsModule = (sdk) => {
    ...
    methods.balanceList.__permission = "manageWallets.balanceList";
    methods.getAll.__permission = "manageWallets.getAll";
    methods.refund.__permission = "manageWallets.refund";
    methods.charge.__permission = "manageWallets.charge";
    methods.transactions.__permission = "manageWallets.transactions";
    return methods;
};
